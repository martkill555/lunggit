<template>
  ...
  <b-navbar toggleable type="dark" variant="dark"  >
    ...
    <router-link :to="{ name: 'Main' }"> <b-navbar-brand> <b-img src="https://cdn.discordapp.com/attachments/678634511214313493/737600952722522133/logo.png" 
  ...
  <b-navbar  >
      <b-button-group class="mx-1">
       <b-button variant="dark" href="/Screen" v-b-tooltip.hover title="Click to start screen" ><b-icon scale="1.50" icon="cloud-plus" variant="white"></b-icon></b-button>  
          <b-button variant="dark" href="/history" v-b-tooltip.hover title="Click to view screen history" ><b-icon scale="1.00" icon="clock-history"></b-icon></b-button>  
